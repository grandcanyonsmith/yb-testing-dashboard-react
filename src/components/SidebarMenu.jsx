...
function SidebarMenu({ isOpen: isSidebarOpen, setIsOpen }) {
  ...
  return (
    <>
      ...
      <div className={`fixed inset-y-0 left-0 transform transition-transform duration-200 ease-in-out bg-gray-900 px-6 overflow-y-auto z-50 ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 md:static`}>
